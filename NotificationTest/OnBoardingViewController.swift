...
//        let bgColorOne = UIColor.blue
//        let bgColorTwo = UIColor.yellow
//        let bgColorThree = UIColor.red
        ...
        return [
            OnboardingItemInfo(informationImage: UIImage(named: "Idle")!,
                               ...
                               pageIcon: UIImage(named: "Idle")!,
                               color: UIColor.bgColorOne,
                               titleColor: UIColor.white,
                               descriptionColor: UIColor.white,
                               titleFont: titleFont!,
                               descriptionFont: descrriptionfont!),
            ...
            OnboardingItemInfo(informationImage: UIImage(named: "JumpShoot")!,
                               ...
                               pageIcon: UIImage(named: "JumpShoot")!,

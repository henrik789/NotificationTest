...
extension UIColor {
    ...
    static let bgColorOne = UIColor(red:0.2, green:0.2, blue:0.2, alpha:1.0)
    static let bgColorTwo = UIColor(red:0.25, green:0.25, blue:0.25, alpha:1.0)
    static let bgColorThree = UIColor(red:0.3, green:0.3, blue:0.3, alpha:1.0)
